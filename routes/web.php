...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/transaction/pay', [TransactionController::class, 'makePayment'])->name('transaction.pay');
    ...
    // Borrowed book return route
    Route::post('/borrowed-books/{borrowedBook}/return', [\App\Http\Controllers\BorrowedBookController::class, 'returnBook'])->name('borrowedBooks.return');
});
