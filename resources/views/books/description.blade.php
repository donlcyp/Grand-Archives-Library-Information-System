                        ...
                        <div class="action-buttons">
                            <div class="borrow-section">
                                @php
                                    ...
                                    $borrowButtonDisabled = $book->quantity <= 0;
                                @endphp
                                ...
                                @endphp
                                @if(!$userBorrowedRecord || ($userBorrowedRecord && $isAdmin))
                                ...
                                @else
                                    <button id="borrow-button" class="borrow-button" disabled title="Only admins can return books">
                                        Return (Admin Only)
                                    </button>
                                @endif
